...
class instive_Shortcode{
	...
	public function init(){
        add_action('elementor/widgets/register', array($this, 'instive_shortcode_elements'));
    ...
    public function instive_shortcode_elements($widgets_manager){
        ...
        $widgets_manager->register(new Elementor\Instive_Main_Slider_Widget());
        
        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/team.php';
        $widgets_manager->register(new Elementor\Instive_Team_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/faqaccordion.php';
        $widgets_manager->register(new Elementor\Instive_Faq_Accordian_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/testimonial.php';
        $widgets_manager->register(new Elementor\Instive_Testimonial_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/insurance-service.php';
        $widgets_manager->register(new Elementor\Instive_Insurance_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/insurance-plan.php';
        $widgets_manager->register(new Elementor\Instive_Insurance_Plan_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/slider-posts.php';
        $widgets_manager->register(new Elementor\Instive_Slider_Post_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/pricing.php';
        $widgets_manager->register(new Elementor\Instive_Pricing_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/search.php';
        $widgets_manager->register(new Elementor\Instive_Search_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/insurace-form.php';
        $widgets_manager->register(new Elementor\Instive_contact_form_Widget());
       
        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/team-slider.php';
        $widgets_manager->register(new Elementor\Instive_Team_Slider_Widget());
       
        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/content-slider.php';
        $widgets_manager->register(new Elementor\Instive_Content_Slider_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/back-to-top.php';
        $widgets_manager->register(new Elementor\Instive_Back_To_Top_Widget());

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/logo.php';
        $widgets_manager->register(new Elementor\Instive_Site_Logo_Widget());

        if(class_exists('\Elementor\Instive_Widget_Blog_Posts')){
            $widgets_manager->register(new Elementor\Instive_Widget_Blog_Posts());
        }

        if(class_exists('\Elementor\Instive_Widget_Client_Logo')){
            $widgets_manager->register(new Elementor\Instive_Widget_Client_Logo());
        }

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/popup.php';
        $widgets_manager->register(new Elementor\Instive_Popup_Widget());  

        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/insurance-category.php';
        $widgets_manager->register(new Elementor\Instive_Insurance_Category_Widget());
        
        require_once INSTIVE_EDITOR_ELEMENTOR.'/widgets/quote-slider.php';
        $widgets_manager->register(new Elementor\Instive_Quote_Slider_Widget());
